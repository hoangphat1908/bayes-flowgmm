...
#         trainer.model.prior = trainers[0].model.prior
    
    ensembles = Ensembles(trainers, all_ensembles=True)
    ...
    filename = "{}_ens_all_{:03}.json".format(args.dataset, random.randrange(1, 10**3))
